...
TURNUS_1_POS = [{1:(88, 115)}, {2:(115, 142)}, {3:(142, 168)}, {4:(168, 195)}, 
                {5:(195, 222)}, {6:(222, 248)}]
TURNUS_2_POS = [{1:(374, 401)},{2:(402, 427)}, {3:(428, 454)}, {4:(455, 480)}, 
                {5:(481, 507)}, {6:(508, 533)}]
# X-akse: fra venstre til høyre
DAG_POS = [{1:(51, 109)}, {2:(109, 167)}, {3:(167, 224)}, {4:(224, 283)}, {5:(283, 340)}, 
            {6:(340, 399)}, {7:(399, 514)}]
REMOVE_FILTER = ['Materiell:', 'Ruteterminperiode:', 'start:', 'Rutetermin:',
